...
from src.usecases.artist.delete_all_artists import DeleteAllArtists
...
async def delete_all_artists(
    ...
    try:
        delete_all_artists_usecase = DeleteAllArtists(artist_repo, artist_image_repo, artist_link_repo, storage_repo)
        output = await delete_all_artists_usecase.execute()
