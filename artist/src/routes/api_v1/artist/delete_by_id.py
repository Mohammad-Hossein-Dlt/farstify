...
from src.usecases.artist.delete_by_id import DeleteArtist
...
async def delete_by_id(
    ...
    try:
        delete_artist_usecase = DeleteArtist(artist_repo, artist_image_repo, artist_link_repo, storage_repo)
