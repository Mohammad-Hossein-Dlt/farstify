...
from src.usecases.image.delete_by_artist_id import DeleteAllImages
...
async def delete_by_artist_id(
    ...
    try:
        delete_all_images_usecase = DeleteAllImages(artist_repo, artist_image_repo, storage_repo)
        output = await delete_all_images_usecase.execute(artist_id)
