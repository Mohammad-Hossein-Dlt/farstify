...
from src.usecases.document.create_all_documents import CreateAllDocuments
from data.documents import all_documents
...
async def create_documents(
    ...
    try:
        ...
        output = await create_documents_usecase.execute(all_documents)
