...
from src.usecases.document.create_document import CreateDocument
...
async def create_document(
    document: CreateDocumentInput = Query(...),
    ...
    try:
        ...
        output = await create_document_usecase.execute(document)
