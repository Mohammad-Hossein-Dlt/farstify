...
from src.usecases.document.update_document import UpdateDocument
...
async def update_document(
    document: UpdateDocumentInput = Query(...),
    ...
    try:        
        ...
        output = await update_document_usecase.execute(document)
