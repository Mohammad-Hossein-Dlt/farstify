...
from src.usecases.episode.image.delete_by_episode_id import DeleteAllImages
...
async def delete_by_episode_id(
    ...
    try:
        delete_all_images_usecase = DeleteAllImages(episode_repo, episode_image_repo, storage_repo)
        output = await delete_all_images_usecase.execute(episode_id)
