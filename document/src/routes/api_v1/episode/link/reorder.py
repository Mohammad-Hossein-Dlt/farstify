...
from src.usecases.episode.link.reorder import ReorderLinks
...
async def reorder(
    ...
    try:
        reorder_links_usecase = ReorderLinks(episode_link_repo)
        outputs_list = await reorder_links_usecase.execute(episode_id, link_ids)
