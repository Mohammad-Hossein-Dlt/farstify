...
class UpdateEpisode:
    ...
    async def execute(
        ...
        try:
            ...
            episode: EpisodeModel = await self.episode_repo.get_by_id(entity.id)
            document: DocumentModel = await self.document_repo.get_by_id(episode.document_id)
            ...
            episode: EpisodeModel = await self.episode_repo.update(episode_model)
