...
from src.usecases.converter.dash import DashConverter
...
async def dash_converter(
    ...
    try:
        ...
        dash_converter_usecase = DashConverter(converter_params, storage_repo, cache_repo, broker_service)
