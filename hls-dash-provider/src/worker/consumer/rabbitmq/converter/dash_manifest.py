...
from src.usecases.converter.dash_manifest import CreateDashManifest
...
async def create_dash_manifest(
    msg: RabbitMessage,
    object_name: str,
    ...
    try:
        ...
        dash_converter_usecase = CreateDashManifest(converter_params, storage_repo, cache_repo, broker_service)
