...
from src.usecases.converter.hls import HlsConverter
...
async def hls_converter(
    ...
    try:
        ...
        hls_converter_usecase = HlsConverter(converter_params, storage_repo, cache_repo, broker_service)
        await hls_converter_usecase.execute(object_name)
