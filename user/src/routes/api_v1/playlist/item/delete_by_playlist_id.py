...
from src.usecases.playlist.item.delete_by_playlist_id import DeleteItems
...
async def delete_by_playlist_id(
    ...
    try:
        delete_items_usecase = DeleteItems(playlist_item_repo)
        output = await delete_items_usecase.execute(playlist_id)
