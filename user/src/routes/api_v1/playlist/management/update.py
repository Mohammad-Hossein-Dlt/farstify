...
from src.usecases.playlist.management.update import UpdatePlaylist
...
async def update(
    ...
    entity: UpdatePlaylistInput = Query(...),
    ...
    try:
        ...
        update_playlist_usecase = UpdatePlaylist(user_repo, playlist_repo, storage_repo)
        
        if file:
            output = await update_playlist_usecase.execute(
                entity,
                file.file,
                file.filename,
                file.size,
            ...
            output = await update_playlist_usecase.execute(entity)
